...
#class Goowe(BaseEstimator):
    ...
    def __init__(self, n_max_components: int = 10,chunk_size: int = 500, window_size: int = 100, logging = True):
        super().__init__()
        ...
        # UPDATE FOR PROBABILITY CALCULATION
    ...
    def prepare_post_analysis_req(self, num_features, num_targets, num_classes, target_values, record=False):
        ...
        self._chunk_data = InstanceWindow( num_features, num_targets,self._chunk_size)
        ...
        # UPDATE FOR PROBABILITY CALCULATION
        self.probability_calculator = ProbabilityCalculation(self._num_classes, self._num_of_max_classifiers)
    ...
    def _get_components_predictions_for_instance(self, inst):
        ...
        # UPDATE FOR PROBABILITY CALCULATION
        self.probability_calculator.iterateVotes(preds)
        return preds
    ...
    def _adjust_weights(self):
        ...
        #print(len(self._chunk_data.get_targets_matrix()))
        y_all = y_all[500:]
    ...
    def partial_fit(self, X, y, classes=None, weight=None):
        ...
        if(len(X) == 1):
            ...
            if(self._num_of_processed_instances % self._chunk_size == 0):
                print("Instance {}".format(self._num_of_processed_instances), flush=True)
                self._process_chunk()
        elif(len(X) > 1):
